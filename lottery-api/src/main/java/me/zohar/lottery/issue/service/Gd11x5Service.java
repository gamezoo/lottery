...
public class Gd11x5Service {
	...
	public Boolean syncLotteryNum() {
		...
		return issueService.syncLotteryNum(Constant.游戏_广东11选5, latestWithInterface.getIssueNum(),
	...
	public IssueVO getLatestLotteryResultWithC8() {
		try {
			...
			log.error("通过c8.cn获取广东11选5最新开奖结果发生异常", e);
		}
		return null;
	}
