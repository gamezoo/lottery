...
@MqConsumer(topic = SyncTjsscLotteryNumTask.TOPIC)
@Component
@Slf4j
public class SyncTjsscLotteryNumTask implements IMqConsumer {

	public static final String TOPIC = "SYNC_LOTTERY_NUM_TJSSC";
	...
	public MqResult consume(String data) throws Exception {
		...
		try {
			...
			syncSuccessFlag = tjsscService.syncLotteryNum();
