...
@MqConsumer(topic = SyncYnsscLotteryNumTask.TOPIC)
@Component
@Slf4j
public class SyncYnsscLotteryNumTask implements IMqConsumer {

	public static final String TOPIC = "SYNC_LOTTERY_NUM_YNSSC";
	...
	public MqResult consume(String data) throws Exception {
		...
		try {
			...
			syncSuccessFlag = ynsscService.syncLotteryNum();
