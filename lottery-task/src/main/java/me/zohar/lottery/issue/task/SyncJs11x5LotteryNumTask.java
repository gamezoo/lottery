...
@MqConsumer(topic = SyncJs11x5LotteryNumTask.TOPIC)
@Component
@Slf4j
public class SyncJs11x5LotteryNumTask implements IMqConsumer {

	public static final String TOPIC = "SYNC_LOTTERY_NUM_JS11X5";
