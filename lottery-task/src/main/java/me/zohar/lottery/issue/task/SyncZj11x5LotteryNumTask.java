...
@MqConsumer(topic = SyncZj11x5LotteryNumTask.TOPIC)
@Component
@Slf4j
public class SyncZj11x5LotteryNumTask implements IMqConsumer {

	public static final String TOPIC = "SYNC_LOTTERY_NUM_ZJ11X5";
	...
	public MqResult consume(String data) throws Exception {
		...
		try {
			...
			syncSuccessFlag = zj11x5Service.syncLotteryNum();
