...
@MqConsumer(topic = SyncJx11x5LotteryNumTask.TOPIC)
@Component
@Slf4j
public class SyncJx11x5LotteryNumTask implements IMqConsumer {

	public static final String TOPIC = "SYNC_LOTTERY_NUM_JX11X5";
	...
	public MqResult consume(String data) throws Exception {
		...
		try {
			...
			syncSuccessFlag = jx11x5Service.syncLotteryNum();
