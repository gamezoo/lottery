...
@MqConsumer(topic = SyncGd11x5LotteryNumTask.TOPIC)
@Component
@Slf4j
public class SyncGd11x5LotteryNumTask implements IMqConsumer {

	public static final String TOPIC = "SYNC_LOTTERY_NUM_GD11X5";
	...
	public MqResult consume(String data) throws Exception {
		...
		try {
			...
			syncSuccessFlag = gd11x5Service.syncLotteryNum();
