...
@Component
@Slf4j
public class SyncSh11x5LotteryNumTask implements IMqConsumer {

	public static final String TOPIC = "SYNC_LOTTERY_NUM_SH11X5";
	...
	public MqResult consume(String data) throws Exception {
		...
		try {
			...
			syncSuccessFlag = sh11x5Service.syncLotteryNum();
